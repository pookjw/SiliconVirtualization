//
//  EditMachineCPUViewController.h
...
@class EditMachineCPUViewController;
@protocol EditMachineCPUViewControllerDelegate <NSObject>
...
@interface EditMachineCPUViewController : NSViewController
...
@property (assign, nonatomic, nullable) id<EditMachineCPUViewControllerDelegate> delegate;
@end
