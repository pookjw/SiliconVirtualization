//
//  EditMachineUSBViewController.h
...
@class EditMachineUSBViewController;
@protocol EditMachineUSBViewControllerDelegate <NSObject>
...
@interface EditMachineUSBViewController : NSViewController
...
@property (assign, nonatomic, nullable) id<EditMachineUSBViewControllerDelegate> delegate;
@end
